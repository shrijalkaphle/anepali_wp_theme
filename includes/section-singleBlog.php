    ...
    <div class="flex items-center">
        ...
        <div>
            ...
            <div class="flex gap-x-2 items-center">
                <button class="p-1.5 bg-enutral-50 rounded-lg border border-neutral-200" onclick='shareToFacebook("<?php the_permalink() ?>")'>
                ...
                <button class="p-1.5 bg-enutral-50 rounded-lg border border-neutral-200" onclick='shareToTwitter("<?php the_permalink() ?>")'>
                ...
                <button class="p-1.5 bg-enutral-50 rounded-lg border border-neutral-200" onclick='shareToLinkedin("<?php the_permalink() ?>")'>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<div class="container my-[70px]">
    ...
    <?php foreach ( $posts_array as $post ) : setup_postdata( $post ); ?>
        <div class="rounded-lg border border-neutral-200 my-[30px]">
